...
const projects = [
  {
    ...
    media: "./assets/videos/ai-tvc-buick-envision-plus-2026.mp4",
    poster: "./assets/images/ai-tvc-buick-envision-plus-2026-cover.jpg",
    layout: "hero",
  },
  {
    ...
    media: "./assets/videos/ai-drama-mermaid-romance.mp4",
    poster: "./assets/images/ai-drama-mermaid-romance-cover.png",
    layout: "portrait",
  },
  {
    ...
    media: "./assets/videos/tvc-wuliangye-brand-film.mp4",
    poster: "./assets/images/tvc-wuliangye-brand-film-cover.jpg",
    layout: "wide",
  },
  {
    slug: "tianhe-jiuxi",
    ...
    media: "./assets/videos/real-estate-tianhe-jiuxi-film.mp4",
    poster: "./assets/images/real-estate-tianhe-jiuxi-note.png",
    layout: "standard",
  },
  {
    ...
    media: "./assets/videos/douyin-hairdryer-product-film.mp4",
    poster: "./assets/images/douyin-hairdryer-product-film-cover.png",
    layout: "portrait",
  },
  {
...
function projectSlide(project, index, count) {
  ...
  return [
    ...
    project.title,
    '">',
    '<video class="depth-carousel__media" muted loop playsinline preload="none"',
    poster,
...
function initializeDepthCarousel(root, items) {
  ...
  function updatePlayback() {
    videos.forEach((video, index) => {
      if (!video) return;
      if (index === activeIndex && inView && !paused && !reduceMotion.matches) {
  ...
  cards.forEach((card, index) => {
    ...
    card.addEventListener("click", () => {
      ...
      if (index === activeIndex) openProject(items[index].slug);
  ...
  openButton.addEventListener("click", () => openProject(items[activeIndex].slug));
...
function setFilter(filter) {
  ...
  const update = () => renderProjects(filter);
...
function openProject(slug) {
  ...
  dialogBody.innerHTML = [
    ...
    '<div class="detail-media"><video controls playsinline preload="metadata" poster="',
    project.poster || "",
    '"><source src="',
    project.media,
    '" type="video/mp4" /></video></div>',
    '<div class="detail-content">',
    '<div class="detail-heading"><p>',
    project.type,
    " / ",
    project.duration,
    '</p><h2 id="dialogTitle">',
    project.title,
    '</h2><p class="detail-lead">',
    project.detail,
    "</p></div>",
    '<dl class="detail-facts">',
    "<div><dt>Creative role</dt><dd>",
    project.role,
    "</dd></div><div><dt>Project focus</dt><dd>",
    project.focus,
    "</dd></div><div><dt>Studio</dt><dd>LULU AI STUDIO</dd></div>",
    "</dl>",
    '<div class="detail-highlights">',
    project.highlights.map((item) => "<p>" + item + "</p>").join(""),
    "</div></div></article>",
  ].join("");
...
document.querySelectorAll("[data-show-category]").forEach((button) => {
  button.addEventListener("click", () => {
    setFilter(button.dataset.showCategory);
    document.querySelector("#work").scrollIntoView({ behavior: reduceMotion.matches ? "auto" : "smooth" });
  });
});
